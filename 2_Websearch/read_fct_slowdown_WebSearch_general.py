...
file = open('/home/wan/Experimental_Graph/paper/2_Websearch/wb_80ms_2_1000_1.txt')  #打开文档
data = file.readlines()
tmp = []
a = []
for num in data:
...
for item in tmp:
    r.append([float(item[1]/1000), max(1, float(item[2]/item[3]))]) #KB,fct_slowdown
...
r_lists = [r_1, r_2, r_3, r_4, r_5, r_6, r_7, r_8, r_9, r_10, r_11]
...
for fct_list in fct_lists:
    line = "%.9f,%.9f,%.9f,%.9f,%.9f,%.9f,%.9f,%.9f,%.9f,%.9f,%.9f"%(fct_list[0], fct_list[1], fct_list[2], fct_list[3], fct_list[4], fct_list[5], fct_list[6], fct_list[7], fct_list[8], fct_list[9], fct_list[10])
    print(line)