...
linewide = 1.5
methods = ['SkyNet_SV_NF', 'SkyNet_SV', 'SkyNet_CV_NF', 'SkyNet_CV']
# -------------------------------
...
ax1.plot(x, SV_NF_avg, color = 'orange', linestyle = '--', label = 'SkyNet_SV_NF', marker = 'v', linewidth = linewide)
ax1.plot(x, SV_avg, color = 'orange', linestyle = '-', label = 'SkyNet_SV', marker = 'v', linewidth = linewide)
ax1.plot(x, CV_NF_avg, color = 'dodgerblue', linestyle = '--', label = 'SkyNet_CV_NF', marker = '^', linewidth = linewide)
ax1.plot(x, CV_avg, color = 'dodgerblue', linestyle = '-', label = 'SkyNet_CV', marker = '^', linewidth = linewide)

ax2.plot(x, SV_NF_99, color = 'orange', linestyle = '--', label = 'SkyNet_SV_NF', marker = 'v', linewidth = linewide)
ax2.plot(x, SV_99, color = 'orange', linestyle = '-', label = 'SkyNet_SV', marker = 'v', linewidth = linewide)
ax2.plot(x, CV_NF_99, color = 'dodgerblue', linestyle = '--', label = 'SkyNet_CV_NF', marker = '^', linewidth = linewide)
...
# -------------------------------
if args.w == 'WebSearch':
    picture_name = '%s_80ms_%d_%s_SkyNet_filter_99'%(args.w, args.lossrate, args.cc)
    ...
    picture_name = '%s_20ms_%d_%s_SkyNet_filter_99'%(args.w, args.lossrate, args.cc)
    plt.savefig('/home/wan/Experimental_Graph/paper/3_Facebook/%s.pdf'%picture_name, format = 'pdf' , dpi = 800 ,bbox_inches = 'tight')
elif args.w == 'Google':
    picture_name = '%s_30ms_%d_%s_SkyNet_filter_99'%(args.w, args.lossrate, args.cc)
